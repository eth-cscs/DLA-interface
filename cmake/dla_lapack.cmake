...
function(dla_find_lapack)
  ...
  if(DLA_LAPACK_TYPE MATCHES "MKL")
    ...
    set(DLA_LAPACK_INTERNAL "${MKL_LIB_DIR} -lmkl_intel_lp64 ${MKL_THREAD_LIB} -lmkl_core -lpthread -lm -ldl")
  elseif(DLA_LAPACK_TYPE STREQUAL "Custom")
    ...
    set(DLA_LAPACK_INTERNAL "${DLA_BLAS_LAPACK_LIB}")
  elseif(DLA_LAPACK_TYPE STREQUAL "Compiler")
    set(DLA_LAPACK_INTERNAL "")
  else()
    message(FATAL_ERROR "Unknown LAPACK type: ${DLA_LAPACK_TYPE)}")
  endif()
  set(DLA_LAPACK_LIBRARY "${DLA_LAPACK_INTERNAL}" CACHE PATH "BLAS/LAPACK link line (autogenerated)")
