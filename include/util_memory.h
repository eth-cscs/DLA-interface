...
namespace dla_interface {
  namespace util {
    namespace memory {
      ...
      // Copies src_ptr[i] to dest_ptr[i] for 0 <= i < n.
      // Precondition: - src_ptr[i] and dest_ptr[i] are valid for 0 <= i < n.
      ...
      // Precondition: - src_ptr[k1] is valid for 0 <= k1 < ld_src * size.second,
