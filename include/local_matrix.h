...
namespace dla_interface {
  ...
  class LocalMatrix {
	...
	/// **Exception:** if the memory has been provided by the user (see @ref note_01 "Note (1)"), the user has to
    ...
    ///
    /// @returns
    /// - nullptr if size().first == 0 or size().second == 0,
    /// - ptr(0, 0) otherwise.
